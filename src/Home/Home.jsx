...
const stepData = [
  ...
  },
  {
    ...
    links: [
      ...
      { primary: true, label: "DOCS", href: 'http://jisungchoi.com/docs/pinch' }
    ],
    background: '#f1f1f1',
    darkmode: false,
    imageUrl: null,
  },
  {
    ...
    links: [
      ...
      { primary: true, label: 'FIGMA', href: 'https://www.figma.com/design/iUEUiDkx3jtnYPtJyTNjjE/Mini-Component-Library?node-id=490-189' },
